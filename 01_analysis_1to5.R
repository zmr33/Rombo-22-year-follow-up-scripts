################################################################################
# SCR and seroprevalence analysis: ages 1-5
#
# Purpose:
#   Calculate seroprevalence, seroconversion rates, and smoothed
#   age-seroprevalence estimates for children ages 1-5.
#
# Author:
#   Zach Reynolds
#
...
#
# Outputs:
#   - outputs/analysis_1to5.rds
#   - outputs/scr_and_seroprev_results_1to5.xlsx
################################################################################
